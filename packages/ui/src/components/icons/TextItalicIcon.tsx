...
type TextItalicIconProps = VariantProps<typeof iconVariants> & {
  className?: string;
};

export const TextItalicIcon: React.FC<TextItalicIconProps> = ({ className, color = "DEFAULT", size = "sm" }) => {
  return (
    <svg
      width="24"
      height="24"

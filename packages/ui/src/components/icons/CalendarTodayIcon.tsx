...
type CalendarTodayIconProps = VariantProps<typeof iconVariants> & {
  className?: string;
};

export const CalendarTodayIcon: React.FC<CalendarTodayIconProps> = ({ className, color = "DEFAULT", size = "sm" }) => {
  return (
    <svg
      width="24"
      height="24"

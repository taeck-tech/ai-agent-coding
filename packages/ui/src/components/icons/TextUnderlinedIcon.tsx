...
type TextUnderlinedIconProps = VariantProps<typeof iconVariants> & {
  className?: string;
};

export const TextUnderlinedIcon: React.FC<TextUnderlinedIconProps> = ({
  className,
  color = "DEFAULT",
  size = "sm",
}) => {

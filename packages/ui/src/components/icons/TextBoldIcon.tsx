...
type TextBoldIconProps = VariantProps<typeof iconVariants> & {
  className?: string;
};

export const TextBoldIcon: React.FC<TextBoldIconProps> = ({ className, color = "DEFAULT", size = "sm" }) => {
  return (
    <svg
      width="24"
      height="24"

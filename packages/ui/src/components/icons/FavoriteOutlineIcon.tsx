...
type FavoriteOutlineIconProps = VariantProps<typeof iconVariants> & {
  className?: string;
};

export const FavoriteOutlineIcon: React.FC<FavoriteOutlineIconProps> = ({
  className,
  color = "DEFAULT",
  size = "sm",
}) => {
